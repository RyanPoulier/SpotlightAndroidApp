 ...
 */
public class ResultsDataAdapter extends ArrayAdapter {
    List list = new ArrayList();
    int check = 1;

    public ResultsDataAdapter(Context context, int resource) {
    ...
    public View getView(int position, final View convertView, final ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = layoutInflater.inflate(R.layout.results_list_row, parent, false);
        ...
        ResultsDataProvider rdataProvider = (ResultsDataProvider) this.getItem(position);
        layoutHandler.TITLE.setText(rdataProvider.getTitle());
        layoutHandler.TIMESTAMP.setText(rdataProvider.getTimestamp());
        layoutHandler.ID.setText(rdataProvider.getID());
